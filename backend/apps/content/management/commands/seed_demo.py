...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        book_authors = {}
        for name in ["Valentina Aguirre", "Ignacio Bravo", "Camila Reyes",
                     "Tomás Vergara", "Josefa Lillo"]:
        ...
        works = {}
        works_data = [
            ("El invierno de las cosas", Work.Kind.POEMARIO, "Alquimia Ediciones", 2023, "Valentina Aguirre"),
        ...
        for title, kind, pub, year, author in works_data:
            w, _ = Work.objects.get_or_create(
                ...
                defaults={"title": title, "kind": kind,
                          "publisher": publishers[pub], "publication_year": year},
            )
        ...
        if art:
            Comment.objects.get_or_create(
                article=art, guest_name="Lector Anónimo",
                defaults={"guest_email": "lector@example.com",
                          "body": "Gran lectura del poemario. Gracias por la reseña.",
                          "status": Comment.Status.APPROVED},
            )
            Comment.objects.get_or_create(
                article=art, guest_name="Comentario Pendiente",
                defaults={"guest_email": "otro@example.com",
        ...
        NewsletterSubscriber.objects.get_or_create(
            ...
            defaults={"status": NewsletterSubscriber.Status.CONFIRMED,
        ...
        call, _ = Call.objects.get_or_create(
            ...
            defaults={"title": "Convocatoria de invierno",
        ...
        Submission.objects.get_or_create(
            ...
            defaults={"author_name": "Colaborador Externo", "type": "reseña",
                      "body": "Adjunto una propuesta de reseña para su evaluación.",
                      "status": Submission.Status.RECEIVED, "call": call},
        )
        ...
        for slug, title, html in [
            ...
            Page.objects.get_or_create(
                slug=slug,
                defaults={"title": title, "body": html,
                          "status": DossierStatus.PUBLISHED},
            )
        ...
        return [
            {
                ...
                "type": ArticleType.RESENA, "section": "Reseñas",
                "status": ArticleStatus.PUBLISHED, "published": now - timedelta(days=2),
                "featured": True, "author": "Fernanda Soto",
                "work": "El invierno de las cosas", "tags": ["poesía", "novedad"],
                "body": body(
            ...
            },
            {
                ...
                "type": ArticleType.RESENA, "section": "Reseñas",
                "status": ArticleStatus.PUBLISHED, "published": now - timedelta(days=6),
                "featured": False, "author": "Andrés Cáceres",
                "work": "Territorio en fuga", "tags": ["narrativa"],
                "body": body(
            ...
            },
            {
                ...
                "type": ArticleType.RESENA, "section": "Reseñas",
                "status": ArticleStatus.PUBLISHED, "published": now - timedelta(days=12),
                "featured": False, "author": "Paula Miranda",
                "work": "Cuadernos del sur", "tags": ["ensayo"],
                "body": body(
            ...
            },
            {
                ...
                "type": ArticleType.ENSAYO, "section": "Ensayos",
                "status": ArticleStatus.PUBLISHED, "published": now - timedelta(days=4),
                "featured": True, "author": "Paula Miranda",
                "work": None, "tags": ["ensayo"],
                "body": body(
            ...
            },
            {
                ...
                "type": ArticleType.ENTREVISTA, "section": "Entrevistas",
                "status": ArticleStatus.PUBLISHED, "published": now - timedelta(days=8),
                "featured": False, "author": "Diego Salinas",
                "work": None, "tags": ["entrevista"],
                "body": body(
            ...
            },
            {
                ...
                "type": ArticleType.RESENA, "section": "Reseñas",
                "status": ArticleStatus.SCHEDULED, "published": now + timedelta(minutes=2),
                "featured": False, "author": "Fernanda Soto",
                "work": "La casa vacía", "tags": ["narrativa"],
                "body": body(
            ...
            },
            {
                ...
                "type": ArticleType.RESENA, "section": "Reseñas",
                "status": ArticleStatus.DRAFT, "published": None,
                "featured": False, "author": "Andrés Cáceres",
                "work": "Antología del margen", "tags": ["poesía"],
            ...
            },
            {
                ...
                "type": ArticleType.RESENA, "section": "Reseñas",
                "status": ArticleStatus.IN_REVIEW, "published": None,
                "featured": False, "author": "Andrés Cáceres",
                "work": None, "tags": ["narrativa"],
    ...
    def _make_article(self, spec, sections, tags, contributors, works, editora, autor_user):
        ...
        ArticleContributor.objects.get_or_create(
            article=article, contributor=contributors[spec["author"]],
            defaults={"position": 0},
        )
        if spec["work"]:
